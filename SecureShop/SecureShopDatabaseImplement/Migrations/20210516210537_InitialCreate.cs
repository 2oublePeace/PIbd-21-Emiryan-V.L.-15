    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentDevices_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentDevices_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentDevices_DeviceId",
                table: "EquipmentDevices",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_EquipmentDevices_EquipmentId",
                table: "EquipmentDevices",
                column: "EquipmentId");
