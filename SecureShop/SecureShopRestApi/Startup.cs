...
namespace SecureShopRestApi
{
	public class Startup
	{
		...
		{
			services.AddTransient<IClientStorage, ClientStorage>(); services.AddTransient<IOrderStorage, OrderStorage>(); services.AddTransient<IEquipmentStorage, EquipmentStorage>(); services.AddTransient<OrderLogic>(); services.AddTransient<ClientLogic>(); services.AddTransient<EquipmentLogic>(); services.AddControllers().AddNewtonsoftJson();
		}
